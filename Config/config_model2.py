...
class Config:
    ...
    def _set_directories(self):
        ...
        # Model 1 directories
        self._MODEL1_TR_DATA = os.path.join(self._DATA_DIR, "model2/model2_train.pth")
        self._MODEL1_VAL_DATA = os.path.join(self._DATA_DIR, "model2/model2_test.pth")
        self._MODEL_OUTPUT = os.path.join(self._OUTPUT_DIR, "model2/model2_weights.pth")
        self._MODEL_OUTPUT_GRAPH = os.path.join(self._OUTPUT_DIR, "model2/training_results.png")
